        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('dashboard/article') }}/{{$id}}" enctype="multipart/form-data">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="POST" action="{{ url('dashboard/article') }}/{{$id}}">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

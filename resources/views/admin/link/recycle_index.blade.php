...
@section('content')
    ...
    <div class="row page-title-row">
        ...
        <div class="col-md-6 text-right">
            <a href="{{url('/dashboard/link/index')}}" class="btn btn-success btn-md">
                <i class="fa fa-mail-reply-all"></i> 返回友链列表
            </a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">已经删除友链列表</h3>
            </div>
            ...
            @foreach ($links as $link)
                <tr>
                    ...
                    <td>{{ $link->link}}</td>
                    <td>
                        <a href="javascript:;" class="btn btn-xs btn-info" onclick="recoveryDel('link',{{$link->id}})">
                            <i class="fa fa-hand-o-right"></i> 恢复
                        </a>
                        <a href="javascript:;" attr="{{$link->id}}" class="btn btn-xs btn-danger realDel">
...
@section('js')
    <script>
        $(document).on('click',".realDel",function () {
            ...
            var d_u = "{{url('/dashboard/link/real_delete')}}"+'/'+id;

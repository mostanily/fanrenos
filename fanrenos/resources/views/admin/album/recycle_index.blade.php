...
function initTable() {
    var requestUrl = "{{url('dashboard/album/recycle_index_table')}}";
    ...
    $table.bootstrapTable({
        ...
        columns: [{
            ...
            formatter: function(value, row, index) {
                ...
                var up = '<a href="javascript:;" class="btn btn-xs btn-info" onclick="recoveryDel(\'album\','+row.id+')"><i class="fa fa-hand-o-right"></i> 恢复</a>';
                return up+d;
            }
        }]
    });
